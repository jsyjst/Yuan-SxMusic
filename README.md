...
请求示例：[https://u.y.qq.com/cgi-bin/musicu.fcg?format=json&data=%7B%22req_0%22%3A%7B%22module%22%3A%22vkey.GetVkeyServer%22%2C%22method%22%3A%22CgiGetVkey%22%2C%22param%22%3A%7B%22guid%22%3A%22358840384%22%2C%22
```html
<font color=#00ffff>*songmid*</font>
```
%22%3A%5B%22
```html
<font color=#00ffff>*001X0PDf0W4lBq*</font>
```
...
| purl | 里面最重要的就是vkey的值，这个值每次请求都不一样     | C400000HjG8v1DTWRO.m4a?guid=358840384&<br>vkey=852D30CD2DEA9E0AFF9CF700977FAFB413A06486CFE8F7250<br>2918665277C5407D8D5AD42039F02329401300003A2853B10816B83C3145159<br>&uin=0&fromtag=66 |
